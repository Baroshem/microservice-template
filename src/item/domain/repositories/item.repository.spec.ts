...
describe('ItemRepository', () => {
    ...
    it('should call item.notifyItemOwner on notifyItemOwner and return item', () => {
        ...
        const result = itemRepository.notifyItemOwner(new ItemCreatedEvent({ name: 'Test' }));
    ...
    it('should call item.notifyItemOwner on notifyItemOwner and return item', () => {
        ...
        const result = itemRepository.notifyItemOwner(new ItemUpdatedEvent({ id: 1, name: 'Test' }));
